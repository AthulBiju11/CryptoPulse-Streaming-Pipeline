...
bronze_df = (spark.readStream.table("cryptopulse_catalog.bronze.coinbase_raw_trades"))

silver_df = bronze_df.withColumn("json_data",from_json(col("body"),json_schema)) \
    .select(
